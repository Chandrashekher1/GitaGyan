...
export function Header() {
    return (
        <div className="border-b border-border/50 backdrop-blur-md sticky top-0 z-50 shadow-elevated flex justify-between px-2 md:px-16 md:py-4 py-3 shadow-lg bg-white/70">
            <div>
